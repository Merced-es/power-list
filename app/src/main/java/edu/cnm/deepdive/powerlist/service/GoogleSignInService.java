...
@Component
public class GoogleSignInService implements ResourceServerTokenServices {
  ...
  @Autowired
  public GoogleSignInService(@Value("${oauth.clientId}") String clientId, UserService userService) {
